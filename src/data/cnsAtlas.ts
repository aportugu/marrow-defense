...
export const CNS_ANATOMY_LABELS = [
  'Choroid plexus', 'Lateral ventricle', 'Interventricular foramen of Monro',
  'Third ventricle', 'Cerebral aqueduct', 'Fourth ventricle',
  'Median aperture (Magendie)', 'Lateral apertures (Luschka)', 'Basal cisterns',
  'Cerebral subarachnoid space', 'Arachnoid granulations', 'Superior sagittal sinus',
  'Penetrating cortical vessel', 'Perivascular space', 'Foramen magnum',
  'Spinal subarachnoid space', 'Lumbar cistern', 'Conus medullaris', 'Cauda equina',
] as const;
...
export const CNS_ATLAS_PANELS: ReadonlyArray<CnsAtlasPanel> = [
  {
    ...
    points: [
      { heading: 'Cerebral microvascular BBB', text: 'Tight-junction endothelium, basement membranes, pericytes, and astrocytic endfeet form the neurovascular unit. The parenchymal route follows a penetrating cortical vessel and perivascular space into white matter.' },
  ...
  },
  {
    ...
    points: [
      ...
      { heading: 'Return pathway', text: 'CSF circulates through cranial and spinal subarachnoid spaces and returns toward dural venous sinuses through arachnoid granulations. The spinal inset is separately scaled.' },
    ],
    references: [
